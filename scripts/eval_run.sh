...
pip install transformers accelerate pydicom pandas opencv-python-headless tqdm timm scipy pycocotools
...
LOG_FILE="detr_eval_${TIMESTAMP}.log"

nohup bash -c "./venv_detr/bin/python3 utils/eval.py" > $LOG_FILE 2>&1 &
